 ...
 */
public class FullTextSessionImpl implements SessionContractOverrides, Serializable {
	...
	public MassIndexer createIndexer(Class<?>... types) {
		...
		return service.createMassIndexer( getSearchFactoryImplementor(), session.getSessionFactory(), types );
	}
	...
	@Override
	public void clear() {
		//FIXME should session clear work with the lucene queue: HSEARCH-1270
		session.clear();
	}
