...
public class DefaultElasticsearchSchemaDropper implements ElasticsearchSchemaDropper {
	...
	@Override
	public void drop(PathComponent indexName, ExecutionOptions executionOptions) {
		schemaAccessor.dropIndex( indexName, executionOptions );
	}

	@Override
	public void dropIfExisting(PathComponent indexName, ExecutionOptions executionOptions) {
