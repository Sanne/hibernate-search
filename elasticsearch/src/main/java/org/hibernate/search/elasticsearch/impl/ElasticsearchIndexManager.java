...
public class ElasticsearchIndexManager implements IndexManager, IndexNameNormalizer {
	...
	private IndexedTypesSet initializedContainedEntityTypes = IndexedTypesSets.empty();
	...
	private void initializeIndex() {
		if ( !indexInitialized ) {
			...
			IndexedTypesSet notYetInitializedContainedEntityTypes = IndexedTypesSets.subtraction( containedEntityTypes, initializedContainedEntityTypes );
	 ...
	 */
	private boolean initializeIndex(IndexedTypesSet entityTypesToInitialize) {
	 ...
	 * (if it's part of the schema management strategy).
	 */
	private void reinitializeIndex(IndexedTypesSet entityTypesToInitialize) {
		if ( schemaManagementStrategy == IndexSchemaManagementStrategy.NONE ) {
			return;
		}
	...
	private IndexMetadata createIndexMetadata(IndexedTypesSet entityTypes) {
