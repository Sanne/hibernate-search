...
public final class ElasticsearchEntityHelper {
	...
	public static boolean isMappedToElasticsearch(ExtendedSearchIntegrator integrator, IndexedTypeIdentifier entityType) {
		IndexedTypesSet entityTypesWithSubTypes = integrator.getIndexedTypesPolymorphic( entityType.asTypeSet() );
		return hasElasticsearchIndexManager( integrator, entityTypesWithSubTypes );
	}

	public static boolean isAnyMappedToElasticsearch(ExtendedSearchIntegrator integrator, IndexedTypesSet entityTypes) {
		IndexedTypesSet entityTypesWithSubTypes = integrator.getIndexedTypesPolymorphic( entityTypes );
		return hasElasticsearchIndexManager( integrator, entityTypesWithSubTypes );
	}

	private static boolean hasElasticsearchIndexManager(ExtendedSearchIntegrator integrator, IndexedTypesSet entityTypes) {
