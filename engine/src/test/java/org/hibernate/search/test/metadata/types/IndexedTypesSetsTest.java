...
public class IndexedTypesSetsTest {
	...
	public void testingLogFormat() {
		...
		final IndexedTypesSet fromClasses = IndexedTypesSets.fromClasses( IndexedTypesSetsTest.class, Foo.class );
	...
	public void testEquality() {
		final IndexedTypesSet a = IndexedTypesSets.fromClasses( IndexedTypesSetsTest.class, Foo.class );
		final IndexedTypesSet b = IndexedTypesSets.fromClasses( Foo.class, IndexedTypesSetsTest.class );
		final IndexedTypesSet c = IndexedTypesSets.fromClasses( Foo.class );
