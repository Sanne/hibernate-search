...
public class AddLuceneWork extends LuceneWork implements Serializable {
	...
	public AddLuceneWork(Object id, String idInString, Class<?> entity, Document document) {
		this( id, idInString, entity, document, null );
	}

	public AddLuceneWork(Object id, String idInString, Class<?> entity, Document document, Map<String, String> fieldToAnalyzerMap) {
