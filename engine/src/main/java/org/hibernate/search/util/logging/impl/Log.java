...
public interface Log extends BasicLogger {
	...
	@Message(id = 176, value = "Could not serialize object %1$s. Not implementing Serializable, a requirement of the used LuceneWorkSerializer")
	SearchException workIdNotSerializable(Object id);
