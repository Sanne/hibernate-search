...
public class InfinispanIndexManager extends DirectoryBasedIndexManager {
	...
	@Override
	public void initialize(String indexName, Properties cfg, Similarity similarity, WorkerBuildContext buildContext) {
		...
		super.initialize( indexName, cfg, similarity, buildContext );
	...
	protected DirectoryProvider<Directory> createDirectoryProvider(
